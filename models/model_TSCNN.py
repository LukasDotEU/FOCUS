# model taken from: https://github.com/JeniferK28/Learning-Spatiotemporal-Graph-Representations-for-Visual-Perception-using-EEG-Signals
# could have also taken a different model from: https://github.com/ljbuaa/VisualDecoding but would have needed to continues wavelet transform as addtional input formulation
